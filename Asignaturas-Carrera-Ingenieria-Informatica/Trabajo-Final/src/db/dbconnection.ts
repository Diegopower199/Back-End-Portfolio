...
export const UsuariosCollection: Collection<UsuarioSchema> =
  db.collection<UsuarioSchema>("Usuarios");

export const PostsCollection: Collection<PostSchema> =
  db.collection<PostSchema>("Posts");

export const ComentariosCollection: Collection<ComentarioSchema> =
  db.collection<ComentarioSchema>("Comentarios");
