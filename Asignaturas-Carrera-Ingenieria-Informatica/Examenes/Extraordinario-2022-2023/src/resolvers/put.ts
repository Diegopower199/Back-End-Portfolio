  ...
  try {
    ...
    if (
      ...
      context.response.body = {
        msg: "Falta algun parametro de estos {id, titulo, fecha, inicio, fin, invitados} ",
      };
    ...
    if (id.match(expresionRegularObjectId) === null) {
      context.response.body = {
        msg: "La campo id no tiene el formato de ObjectId",
      };
    ...
    if (typeof titulo !== "string") {
      context.response.body = {
        msg: "La campo titulo no es de tipo string",
      };
      context.response.status = 404;
      return;
    }
    ...
    if (typeof descripcion !== "string" && typeof descripcion !== "undefined") {
      context.response.body = {
        msg: "La campo descripcion no es de tipo string",
      };
      context.response.status = 404;
      return;
    }

    const expresionRegularFecha =
      /^([12]\d{3}-(0[1-9]|1[0-2])-(0[1-9]|[12]\d|3[01]))$/;

    if (fecha.match(expresionRegularFecha) === null) {
      context.response.body = {
        msg: "La campo fecha debe tener este formato yyyy/mm/dd",
      };
      context.response.status = 404;
      return;
    }
    ...
    if (typeof inicio !== "number" || !Number.isInteger(inicio)) {
      context.response.body = {
        msg: "El campo inicio no es de tipo entero (number)",
      };
      context.response.status = 404;
      return;
    }
    ...
    if (typeof fin !== "number" || !Number.isInteger(fin)) {
      context.response.body = {
        msg: "El campo fin no es de tipo entero (number)",
      };
      context.response.status = 404;
      return;
    }
    ...
    if (
      ...
      !invitados.every((item) => typeof item === "string")
    ) {
      context.response.body = {
        msg: "La variable invitados no es un array de strings",
      };
      context.response.status = 404;
      return;
    }
    ...
    if (inicio >= fin) {
      context.response.body = {
        msg: "La hora de finalizacion no puede ser menor o igual que la de inicio",
      };
      context.response.status = 400;
      return;
    }
    ...
    if (fin > 24) {
      context.response.body = {
        msg: "La hora de fin no puede ser mayor que 24",
      };
      context.response.status = 404;
      return;
    }
    ...
    if (!eventoEncontrado) {
      context.response.body = {
        msg: "No existe el id del evento",
      };
      context.response.status = 404;
      return;
    }
