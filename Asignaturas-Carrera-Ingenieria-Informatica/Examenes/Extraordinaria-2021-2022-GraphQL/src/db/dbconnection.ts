...
export const PressHouseCollection: Collection<PressHouseSchema> =
  db.collection<PressHouseSchema>("PressHouses");
export const AuthorsCollection: Collection<AuthorSchema> =
  db.collection<AuthorSchema>("Authors");
export const BooksCollection: Collection<BookSchema> =
  db.collection<BookSchema>("Books");
